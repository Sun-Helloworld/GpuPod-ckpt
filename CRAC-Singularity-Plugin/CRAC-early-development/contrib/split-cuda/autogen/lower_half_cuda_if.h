...
MACRO(cusparseCreateHybMat) ,\
MACRO(cusparseDestroyHybMat) ,\
MACRO(cusparseCreateSolveAnalysisInfo) ,\
MACRO(cusparseDestroySolveAnalysisInfo) ,\
MACRO(cusparseDcsr2csc) ,\
MACRO(cusparseDcsr2hyb) ,\
MACRO(cusparseDcsrmv) ,\
MACRO(cusparseDcsrsv_analysis) ,\
MACRO(cusparseDcsrsv_solve) ,\
MACRO(cusparseDhyb2csr) ,\
MACRO(cusparseDhybmv) ,\
...
MACRO(cuDevicePrimaryCtxRelease) ,\
MACRO(cuDevicePrimaryCtxReset) ,\
MACRO(cuDevicePrimaryCtxRetain) ,\
MACRO(cuDevicePrimaryCtxSetFlags) ,\
